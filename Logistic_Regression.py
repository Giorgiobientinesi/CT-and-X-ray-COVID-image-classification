...
model = LogisticRegression() #Run the model and find the best structure
grid_search = HalvingGridSearchCV(model, random_grid, random_state=0, verbose=1) #cv default = 5
