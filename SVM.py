...
from sklearn.experimental import enable_halving_search_cv  #!pip install scikit-learn==0.24.2
...
model = SVC() #Run the model and find the best structure
grid_search = HalvingGridSearchCV(model, tuned_parameters, scoring="accuracy",verbose=3) #cv default = 5
